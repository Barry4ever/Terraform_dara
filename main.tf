...
resource "hyperv_network_switch" "test_network"{
    name = "upgrade_pdm"
...
resource "hyperv_vhd" "sqlserverpdm"{
  #path = "C:\\ClusterStorage\\Volume12\\sqlserverpdm.vhdx"
  path = "D:\\SQLupgrade"
  size = 32212254720 #30 Gigas
}
...
resource "hyperv_machine_instance" "default" {
  ...
  network_adaptors {
    name                                       = "wan"
    switch_name                                = hyperv_network_switch.test_network.name
    management_os                              = false
    is_legacy                                  = false
  ...
  dvd_drives {
    ...
    #path                = ""
    path                = "\\midsrvfs\\mid_software\\09 Windows\\Windows Server 2019\\w2019.iso"
    resource_pool_name = ""
  }
  ...
  hard_disk_drives {
    ...
    controller_number               = "0"
    controller_location             = "0"
    path                            = hyperv_vhd.sqlserverpdm.path
